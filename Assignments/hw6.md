...
\times 4$$, where $$M = 33787$$ is the number of action potentials detected,
...
1. _Plot the spike peaks in 4-D space (10 pts)_
...
2. _Clustering with K-Means (40 pts)_
...
3. _Gaussian Mixtures (20 pts)_

    **THIS QUESTION IS INCLUDED ONLY FOR REFERENCE - DO NOT TURN IN.**

    Consider the plot of snippet peaks you made for problem (1). The clouds of
...
4. _Using Gaussian Mixtures (50 pts)_
   ...
   ```
    ...
    file (SpikeData12.npy)[SpikeData12.npy], and find the waveform peaks as in
    **(1)**.
