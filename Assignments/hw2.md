...
3. _Simulating a neuron (65 pts)_ 
   ...
   For the following problems, you will make sure of MATLAB code that simulates a neuron (hh.py
   and code you will write). You should use a time step, Δt  = 0.01 ms (except for **3b**).
